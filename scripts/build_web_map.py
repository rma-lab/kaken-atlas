...
function toggleView() {
  ...
  else animateRange([xs[selGid] - NEAR_SPAN, xs[selGid] + NEAR_SPAN], [ys[selGid] - NEAR_SPAN, ys[selGid] + NEAR_SPAN], 1200);
}
...
function focusPoint(gid) {
  ...
  animateRange([xs[gid] - NEAR_SPAN, xs[gid] + NEAR_SPAN], [ys[gid] - NEAR_SPAN, ys[gid] + NEAR_SPAN], 1200);
}
