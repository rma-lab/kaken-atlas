...
# 大区分の便宜的通称（公式名は A〜K のみ。所属中区分から付けた。正典 data/reference/kubun_table.csv で
# 確認済み 2026-09-07: C=中区分18–25 土木・建築・機械・電気等、D=26–31 応用物理・材料・化学工学・ナノ等、
# E=32–37 化学。以前は C=化学・D=工学・E=材料と取り違えていた）
DAI_GLOSS = {
    "A": "人文学・社会科学", "B": "数物系科学", "C": "工学", "D": "応用物理・材料工学",
    "E": "化学", "F": "農学", "G": "生物学", "H": "薬学・基礎医学",
